...
public class Maze implements MazeModel {
  ...
  /**
   * Sets the previous element of a {@code Model.MazeSquare}.
   ...
   * @param visited the {@code Set<Model.MazeSquare>} of all visited {@code MazeSquares}
   ...
   * @param visited the {@code Set<Model.MazeSquare>} of {@code Model.MazeSquare} objects previously processed.
   */
  ...
  /**
   * Sets all of the fields other than color in each {@code Model.MazeSquare} object in the maze.
   */
  ...
  /**
   * Initializes only the colors of the {@code Model.MazeSquare} objects in the maze.
   */
